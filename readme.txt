...
= Version 1.2.5 =
- Better screenshot 1200x900 provided
- Fixed customizer prefix
- Removed author.php
- Removed unused PHP file
- Constant prefixed
- Escaped admin_url with esc_url & get_header_url
...
= Version 1.3.1 =
- Recommend the Atlast Business Theme Styling Customizer plugin
...
= Version 1.4.6 =
- Mobile options section added
- Mobile header alternative layout with the logo in the middle

= Version 1.4.7 =
- One new style in about section added
- Pages now can use excerpts
...
- Create Blog carousel as 2 blog section style

= Version 1.5.0 =
- Services section now support page excerpt.
...
= Version 1.5.8 =
- Added metabox.io plugin compatibility and new pages metaboxes via the Atlast Business Styling Customizer.
- Added compatibility with the Famous WPForms Plugin
...
= Version 1.5.8.3 =
- Added Subheading Text in header
